...
{% hint style="danger" %}
请注意，该教程必须从头看到尾，线性阅读注意顺序，否则会失败！
{% endhint %}

{% hint style="warning" %}
在打开软件时请注意两点事项：

* SSR需要权限，请非管理员用户右键使用管理员权限打开SSR，并且在防火墙询问时赋予其全部权限。
* 刚打开时小飞机图标可能为绿色，此时请您右键小飞机，将系统代理模选择直连，否则可能影响接下来的配置。

![](../../.gitbook/assets/snipaste_2019-07-05_12-21-20.png) 
{% endhint %}
...
1. 右键**小飞机图标**。
2. 选择\[服务器\] --&gt; \[Ctcloud-xx线路\]
3. 选择您喜欢的节点即可。

![](../../.gitbook/assets/snipaste_2019-07-13_11-58-54.png)

{% hint style="warning" %}
请不要使用 **“编辑服务器”** 选项选择节点，那是无效的！！！
{% endhint %}
